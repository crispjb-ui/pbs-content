...
**Format:** Single conceptual infographic, "12-Cent Pill in a $9 Museum Frame" — one small pill mounted inside an oversized but MINIMAL modern gallery frame rendered in the PBS brand palette (flat deep Primary Blue field, clean thin white frame, Accent Blue mat; NO gold, NO ornament, NO photoreal gallery lighting), a tiny "$0.12" tag on the pill and a "$9.00" placard on the frame, so the absurd gap between the pennies-to-make pill and the $9 the plan paid IS the image. Clean, flat, professional infographic register. 1080 x 1350 px. Apply the mobile-feed legibility rule: the two dollar figures dominate the center ~70% and read at 400px thumbnail.
**Pillar:** PBM Contract Insights
...
> A clean, flat conceptual infographic, 1080 x 1350 pixels (4:5 vertical), professional editorial style in the PBS brand palette ONLY (Primary Blue #015880, Accent Blue #A7E0FA, Gray #4D4D4D, White). NOT a photograph, NOT ornate, NO gold, NO photoreal gallery lighting: think a modern, minimal corporate-infographic illustration, restrained and credible. Background: a flat deep Primary Blue (#015880) field with generous negative space and no texture. Centered on it hangs one oversized but MINIMAL rectangular frame, like a clean modern art-gallery frame: a thin White border around a solid Accent Blue (#A7E0FA) mat. No ornament, no gilding, no gold. The frame is nearly empty: dead center inside the wide mat sits one small single white round generic pill with a soft flat shadow, absurdly tiny against the large frame. The joke is the mismatch: a pennies pill framed like priceless art, rendered in clean brand style. CRITICAL: this is read in the LinkedIn mobile feed, so the two dollar figures must DOMINATE the center ~70% of the frame and be large and legible at ~400px thumbnail. Keep every other detail minimal. Cap the scene at five elements total. No logos, no brand marks, no people, no real names, no PBM names.
>
> Two-tone headline across the top in IBM Plex Sans SemiBold, large: line 1 "THE 12-CENT PILL" in White, line 2 "IN A $9 FRAME" in Accent Blue (#A7E0FA). The numerals "12" and "9" inside the headline set in IBM Plex Mono, tabular figures.
>
...
>
> Element B: a clean rectangular placard on the bottom rail of the frame — a solid White plate with "$9.00" in large Primary Blue (#015880) IBM Plex Mono Medium, tabular figures. This is the largest single number in the image, reading instantly at thumbnail.
>
> Element C: a small clean wall label to the lower right of the frame, in IBM Plex Sans, White, two short lines: "Generic tablet. / Pharmacy cost: 12c. Plan paid: $9.00."
>
> Footer line along the very bottom in IBM Plex Sans SemiBold, White with the dollar figure in Accent Blue and Plex Mono: "Pennies to make. Dollars to your plan. The PBM set both prices."
>
> Style: clean flat infographic, PBS brand palette only, flat deep Primary Blue field, minimal thin white frame with an Accent Blue mat, generous negative space, sharp crisp edges. Professional and restrained: NO gold, NO ornamental detail, NO photoreal gallery lighting. The $0.12 tag and the $9.00 placard are the two anchors and must be the most legible things in the frame. Any incidental text beyond the labeled numbers and headline is illustrative. No logos, no brand marks, no people, no PBM names.
...
| Post 103 "12-Cent Pill in a $9 Museum Frame" conceptual image | Single image (1080x1350) | Generic-spread reveal, CLEAN BRAND-COLORED INFOGRAPHIC (flat deep Primary Blue field, minimal white frame, Accent Blue mat; no gold, no photoreal): one small pill in an oversized minimal frame, $0.12 tag on the pill vs $9.00 placard on the frame; two-tone Plex Sans headline, Plex Mono dollar figures; mobile-legibility pass mandatory on the two numbers; PBS logo added in Canva |
