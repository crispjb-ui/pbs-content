...
- **Third-party LinkedIn engagement-comment rule (added June 9, 2026):** When Ginny is handed someone else's LinkedIn post to comment/reply on (a broker's post, a journalist's, an amplifier-reposted post), draft in her brand voice using this pattern: (1) **Brand-filter first, skip the off-brand ones.** Only engage posts that are on-pillar PBM/pharmacy-benefits and adversary-correct (PBM as structural adversary). If a post is off-brand, polarizing, or pulls Ginny's positioning sideways, skip it rather than forcing a comment. (2) **Affirm the author as ally, never correct.** Brokers/advisors are partners (the Week 14 constraint applies in comments too): open by agreeing with their point, then add, don't rebut. (3) **Add one structural value layer the post didn't cover** — preferably a genuinely-unknown hidden-structure fact (rebate aggregators/GPOs Ascent·Emisar·Zinc, the GPO fee skim before "pass-through," copay maximizers, PBM-owned specialty/mail routing). This is the value-add that earns the comment and is the shape amplifiers (Cuban) engage with. (4) **Proprietary anchor required** ("we review hundreds of contracts a year at PBS," a specific clause gap). (5) **No self-promo link in the lead comment** on someone else's post (reads as hijacking); if a cross-promo is wanted, it goes as a self-reply under Ginny's own first comment, not the lead. (6) Brand mechanics still apply: no em-dash/" - " separators, no fabricated numbers, named-actor framing, AI-tell blacklist. Canonical example: the June 2026 Benefits Blake "Optum 100% pass-through" post (Cuban-reposted), where the winning comment affirmed Blake's "revenue relocates" thesis and added the rebate-aggregator (Emisar) layer the announcement omits.
...
- **Followers:** 2,040 (as of June 5, 2026; was 1,903 on May 25, 1,866 on May 22, 1,374 on April 3)
...
- **Subscribers:** 1,017 (as of June 5, 2026; crossed 1,000; was 930 on May 25, 913 on May 22, 605 on April 3)
...
- **Handle:** @ginnycrisp
- **Subscribers:** 97 (as of June 5, 2026; 2 paid. Was ~80 on May 25 (1 paid), 78 on May 22, 15 on April 3). Second paid sub added in early June.
