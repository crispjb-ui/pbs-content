...
If results imply a change to a standing rule (a shape to retire, a posting-time finding, a fatigued format), flag it for CLAUDE.md and add it to `OPEN_ITEMS.md`. Note any post worth repurposing in `repurpose_queue.md`.
