...
| Wed May 27 | 7:30 AM | Substack | Weekly Roundup "What Crossed My Desk This Week" — **verify lead = CVS 340B lawsuits and #2 = Pennsylvania Insurance Department Act 77 PBM study before publish; if auto-routine overwrote either, restore manually.** W20 history shows automation has overwritten pre-curated leads before. | [ ] |
...
- [ ] **Wed Substack Roundup (Wed 7:30 AM) story-order verification: CVS Health 340B lawsuits MUST be lead story; Pennsylvania Insurance Department Act 77 PBM study MUST be #2 story.** Tuesday May 26 morning, after auto-generation runs, open `newsletters/roundups/roundup_2026_05_26.md` and confirm both. Lead: CVS / Mount Sinai / U Michigan / U Kansas 340B suits (filed May 21, ~$250M alleged diversion). #2: PA PID study released May 21 under Act 77 — Freedman Healthcare analysis of Caremark / Express Scripts / Navitus / OptumRx / Prime Therapeutics on 2022-2024 fully-insured data; findings: steering limited, spread pricing decreasing under state pressure, NADAC + $10.49 would redistribute $14M (0.3%) to independent retail pharmacies. **Dual-narrative framing:** CVS lawsuit shows where extraction migrates next (vertical integration in 340B + commercial); PA study shows where state pressure has reshaped traditional spread pricing. PBS's read: the two stories together = PBMs are evolving extraction methods faster than regulators can document them. If automation surfaced different leads, manually re-anchor before publish. W20 history (`roundup_2026_05_19.md` header line 2) shows automation has overwritten pre-curated leads before; do not assume this is locked.
