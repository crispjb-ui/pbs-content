# Week 30 Newsletter Bundle: Site-of-Care Optimization
## July 27-31, 2026
...
I share this because site-of-care is the cost lever that sits at the intersection of the pharmacy benefit and the medical benefit, and most employers have never evaluated it because those two benefits rarely talk to each other. The pharmacy team manages the drug. The medical team manages the administration. The cost of the drug and the cost of administering it are billed through different channels with different pricing structures. Nobody looks at the total.

**Why the setting matters more than the drug**

For provider-administered drugs (infusions, injections given in a clinical setting), the cost has two components: the drug cost and the facility/administration cost. The drug cost may be similar across settings. The facility cost is where the variation lives.

Hospital outpatient departments apply facility fees that can multiply the administration cost. The same infusion administered in an ambulatory infusion center or at home avoids those fees. For high-cost biologics with frequent administration schedules, the annual facility fee difference per member can be substantial.

This is not a quality issue. Clinical guidelines for most infusion therapies do not require hospital administration after the initial doses. Patients who are clinically stable, who tolerate the therapy, and who have appropriate home or ambulatory access are candidates for lower-cost settings. The clinical criteria are well established. The default routing to hospital outpatient is an inertia problem, not a clinical necessity.
...
This is the framework we use with clients, organized by therapeutic category. For each category, the decision follows a clinical and financial pathway.

**Oncology infusions:**
Start at hospital outpatient or physician office for initial cycles (clinical monitoring essential). After established tolerance (typically 2-3 cycles with no adverse events), evaluate ambulatory infusion center as alternative. Home infusion generally not appropriate for most oncology regimens due to monitoring requirements, though some maintenance therapies qualify.

**Rheumatology infusions (e.g., infliximab, rituximab):**
Initial infusion at hospital outpatient or physician office. After established tolerance, ambulatory infusion center or home infusion are both appropriate. This category typically has the largest site-of-care savings opportunity because the therapies are long-term maintenance with predictable administration schedules.

**Neurology infusions (e.g., natalizumab, ocrelizumab):**
Initial infusions at hospital outpatient with monitoring capability. Some therapies have specific REMS (Risk Evaluation and Mitigation Strategy) requirements that dictate the setting. After REMS requirements are met and tolerance is established, ambulatory infusion center is often appropriate. Home infusion possible for select therapies with appropriate nursing support.

**Rare disease infusions (e.g., enzyme replacement therapies):**
...
> A clean, flat corporate infographic, 1080 x 1350 pixels (4:5 vertical), on a white (#FFFFFF) background with generous margins, designed as a four-setting cost ladder for site-of-care decisions. Top: a full-width Primary Blue (#015880) header band about 170px tall containing the two-tone title in IBM Plex Sans SemiBold (clinical register, never a condensed or poster face): "4 Settings." in white (#FFFFFF, about 52pt) with "1 Decision." in Accent Blue (#A7E0FA, about 40pt) directly beneath, left-aligned, and a small white outline building icon at the right of the band. Body: four evenly spaced horizontal setting rows descending like a ladder from highest cost at the top to lowest at the bottom, each a rounded card with a bold traffic-light left cap, a simple flat setting icon, the setting name in Gray (#4D4D4D) IBM Plex Sans Medium (about 26pt), a short annotation line in Gray IBM Plex Sans below it, and a large dollar indicator in IBM Plex Mono tabular figures at the right edge. Row 1, Red (#C0392B) cap, hospital-building icon, "HOSPITAL OUTPATIENT", annotation "Initial infusions. Complex therapies. High monitoring.", indicator "$$$$". Row 2, Amber (#F5A623) cap, physician-office icon, "PHYSICIAN OFFICE", annotation "Prescriber administers. Moderate cost.", indicator "$$$". Row 3, Green (#2E7D32) cap, clinic icon, "AMBULATORY CENTER", annotation "Purpose-built. No facility fees.", indicator "$$". Row 4, Green (#2E7D32) cap, house icon, "HOME INFUSION", annotation "Lowest cost. Member convenience.", indicator "$". A slim downward Accent Blue (#A7E0FA) arrow runs along the left edge beside the four caps implying descending cost. Below the four rows, a slim Accent Blue (#A7E0FA) footer bar holds "Clinically stable + established therapy? Move down the ladder." in Primary Blue IBM Plex Sans SemiBold. Render every dollar indicator in IBM Plex Mono, tabular figures. Large, high-contrast, thumbnail-legible type throughout, nothing beyond the four rows and the footer competing for attention. Reserve empty space at the bottom-right for a logo (do not draw one), and place a small footer line "rxbs.org" in IBM Plex Mono Gray (#4D4D4D) at the bottom-left. No grid-pattern background, no photographs, no people, no real logos, no PBM logos. Color palette strictly: white (#FFFFFF), Primary Blue (#015880), Accent Blue (#A7E0FA), Gray (#4D4D4D), plus the traffic-light accents Green (#2E7D32), Amber (#F5A623), Red (#C0392B).

---

### Sources

- AMCP Site-of-Care Optimization Guidelines
- National Home Infusion Association (NHIA) Clinical Standards

### Article Meta

**SEO Title:** Site-of-Care Optimization: Decision Tree by Therapeutic Category | Benefit Blind Spots
**SEO URL Slug:** site-of-care-optimization-decision-tree
**Meta Description:** The administration setting can change infusion cost by multiples. A therapeutic-category decision tree with clinical and financial criteria for each setting.
**Tags:** site of care, infusion therapy, cost containment, white bagging, home infusion, self-funded employers
...
## The Pharmacy Benefits Briefing - Issue #25
### Site-of-Care Briefing

**Publish:** Monday, July 27, 2026 at 7:45 AM EST
...
Four settings exist for most infusion therapies: hospital outpatient (highest cost), physician office (moderate), ambulatory infusion center (lower), and home infusion (lowest). For clinically stable members on established therapies, the lower-cost settings are clinically appropriate and substantially less expensive.

This is not a quality issue. Clinical guidelines do not require hospital administration for most maintenance infusions after the initial doses. The default routing to hospital outpatient is inertia, not clinical necessity.

The challenge is that site-of-care crosses the pharmacy and medical benefit boundary. The drug is covered under one. The administration under the other. Optimization requires coordination between PBM, medical plan, providers, and members. Your broker can help coordinate across vendors.

---

This week's Benefit Blind Spots includes a **site-of-care decision tree**: therapeutic category-specific frameworks (oncology, rheumatology, neurology, rare disease) with clinical and financial criteria for evaluating administration settings. That decision tree is exclusive to the Substack: [SUBSTACK URL]
...
[Conversational.]
"Hospital facility fees do not improve outcomes for stable infusion patients. They improve the hospital's revenue. Ambulatory centers and home infusion eliminate those fees entirely."
...
> **Content-mix check (39 scheduled posts: 5/weekday + 7/weekend).** Daytime backbone: weekday AM recipes (named program · hidden extraction, Tier B) + weekend Tier A Cuban-bait recipes (Sat/Sun 8 AM + the four 10 AM / 2:30 PM Tier-A adds: price protection, copay accumulator, copay maximizer vendor, brown bagging) ✓ · midday news-reaction HOLDs with quiet-day decoder backups across all seven days ✓ · PM punchy pool Mon-Sat + the one weekly origin (Sun 5 PM) ✓. Evening block: 7 question posts (7 PM, evergreen/schedulable) + 3 aphorisms + 3 one-questions + 1 origin-anchored (capped 1/week, Fri 8:30 PM) ✓. Newsjack/bridge (E/F) held for reactive bumps. Weekday = 5 posts (8 AM / 12 PM / 5 PM / 7 PM / 8:30 PM); weekend = 7. Weekend Tier A per the Q3 rotation in `x_recipe_post_bank.md`; when Cuban reposts a weekend Tier A post, re-pin it and thread a second Tier A program within the hour. Rotation tracked in `x_evening_block_bank.md`; nothing repeats inside ~2 weeks.
...
## Video Test Summary (After 3 Tests)

| Test | Week | Format | Impressions | Eng Rate | Profile Views |
|------|------|--------|------------|----------|---------------|
| #1 | 26 | Video | | | |
| #2 | 28 | Video | | | |
| #3 | 30 | Video | | | |
| Baseline | Avg | Text | | | |
| **Decision:** | If video avg > 5K impressions → default Wed format. If not → occasional alternative. |
