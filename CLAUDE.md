...
- **Thursday visual evergreen rotation (added April 17, 2026):** Thursday LinkedIn feed visual rotates through three evergreen formats on pillars DIFFERENT from Monday's topic, to protect Thursday reach from same-topic fatigue. Rotation: A) Contract Language Decoder (messy infographic), B) "Same X. Same Y. Different Z." (carousel), C) "5 Questions Your PBM Hopes You Don't Ask" (carousel). Week 15 Thursday visual on Monday topic hit 340 impressions; rotating to different pillar protects against that compression.
