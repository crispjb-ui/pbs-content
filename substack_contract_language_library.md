...
- **Library 07 (W36, Sep 8, 2026):** Q4 cost-pattern clauses from the "Three clauses behind every Q4 cost pattern" carousel (Accumulator Adjustment § 6.03, Channel Pricing and Refill Timing § 4.08, Claim-Year Cutoff § 4.05) — all new provisions. Renumbered Jul 21, 2026 from a duplicate "Library 06" eyebrow found in the W36 file; W36 now carries the Library Update section. Copay-program neutrality rule applies to the accumulator provision framing.
