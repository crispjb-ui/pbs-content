...
|-----|----------------------|---------------|--------|-----|
| Mon Aug 17 | #14 Pass-through definition trick | toolkit/rebate-report-audit | news-hold · D1 | P1 |
| Tue Aug 18 | #15 Auto-renewal / lock-in | toolkit/termination-clause-audit | news-hold · D2 | P2 |
| Wed Aug 19 | #16 Audit rights limitation | Contract Library | news-hold · D3 | P3 |
| Thu Aug 20 | #17 MAC list control | toolkit/channel-pricing | news-hold · D4 | P4 |
| Fri Aug 21 | #18 Manufacturer-fee reclassification | toolkit/pbm-compensation | news-hold · D5 | P5 |
| **Sat Aug 22** | **#1 Copay accumulator (Tier A)** | toolkit/copay-card-calculator | D6 | P6 |
| **Sun Aug 23** | **#5 Rebate aggregator (Tier A)** | toolkit/rebate-report-audit | D1 | origin O3 |

> Weekend Tier A per the Q3 rotation (Sat copay accumulator / Sun rebate aggregator — the two strongest Cuban-bait shapes, paired on the highest-traffic weekend). AM text + pool items in `x_recipe_post_bank.md`.
