...
SPECS = [
    {
        ...
        "title_sub": "The pre-engagement checklist for plan sponsors considering a contract review. Built from the engagement workflow PBS uses across hundreds of PBM contract reviews annually.",
    ...
    },
    {
        ...
        "passes": [
            (1, "Quantify the gap (dollar magnitude of audit findings)",
             "<p>Estimate the annual dollar impact of each contract-review finding: rebate-definition narrowing · GER miss × claims volume · channel-margin spread × specialty claim volume · network drift × per-claim impact · performance-remediation owed × frequency. The pattern: when audit findings exceed roughly 5-7% of total annual pharmacy spend, the gap is large enough that going to market is typically worth the disruption. Below that threshold, optimizing existing usually wins.</p>"),
            (2, "Negotiability assessment of the current PBM",
             "<p>How responsive is the current PBM to amendments? Look at prior amendment history (accepted redlines in past 24 months?), account team responsiveness during the contract review, disclosure-obligation fulfillment, and response to mid-year notifications. A responsive PBM with a minor-to-moderate gap = optimize existing. A non-responsive PBM with any gap = go to market regardless of dollar magnitude, because the gap will widen at every renewal.</p>"),
            (3, "Switching cost analysis",
             "<p>If go-to-market is on the table, what does the switch actually cost? Member disruption risk, data portability, runoff economics, early-termination fees, implementation timeline (4-6 months minimum). The Termination Clause and Member Transition Audit Toolkits feed this assessment. Weak termination or weak data return obligations meaningfully raise switching cost.</p>"),
        ],
    ...
    },
    {
        ...
        "intro": "This is the self-service version of the Pharmacy Benefit Review (PBR), a twice-yearly comprehensive audit PBS runs for clients across six categories of pharmacy benefit performance. Each category has three to four audit items. Run the full framework at the mid-point of your plan year and again roughly 60 days before renewal to surface the patterns that decide your negotiation position. PBS clients receive a written PBR report; plan sponsors running this internally produce the same artifact.",
        "passes": [
            (1, "Run the six-category audit",
             "<p>The PBR covers six categories: <strong>Financial Performance</strong> · <strong>Contract Compliance</strong> · <strong>Clinical Programs</strong> · <strong>Member Experience</strong> · <strong>Vendor Management</strong> · <strong>Strategic Position</strong>. Each category has 3-4 audit items (20 total). Pull the data package on page 2 from the PBM; score each item 1-5 against the data. The rubric and dollar magnitude live in the per-mechanic Toolkit handouts (Channel Pricing, Rebate Audit, GER Audit, PBM Compensation, Specialty Routing).</p>"),
            (2, "Score and interpret",
             "<p>Total score across the 20 items: 20-100. <strong>Below 50:</strong> meaningful unrealized cost containment + member experience risk; bring full audit findings to the next renewal cycle. <strong>50-70:</strong> mixed results, focus the next 90 days on the lowest-scoring category. <strong>Above 70:</strong> strong PBM oversight position; document the wins, refresh at the next half-year review, shift focus to renewal readiness.</p>"),
            (3, "Bring the PBR to renewal",
             "<p>Plan sponsors with documented PBR audit findings negotiate different renewal terms than plan sponsors who walk in with the PBM's summary report. The PBR is the counter-narrative. Build the written report (analysis + findings + redline agenda) and pre-circulate to the benefits committee before the first renewal meeting.</p>"),
        ],
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> the plan sponsors who run a structured semi-annual PBR (with this framework or one like it) walk into renewal with documented gaps that move terms. The plan sponsors who do not run the audit walk into renewal with the PBM's summary report as their only reference and inherit the PBM's frame.",
        ...
        "actions": [
            ("MID-PLAN-YEAR PBR", "Pull the six-category data + score the framework", "Use this checklist alongside the per-mechanic Toolkit handouts. The Channel Pricing, Rebate Audit, GER Audit, PBM Compensation, and Specialty Routing Toolkits all feed into the financial performance and contract compliance categories."),
            ("PRE-RENEWAL PBR · ~60 DAYS OUT", "Re-run the framework + write the period-over-period comparison", "The pre-renewal PBR is the most useful single document a plan sponsor can take into a renewal cycle. The period-over-period comparison shows the trajectory PBM definitions and economics moved across the year, the silent drift the contract reads through."),
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> the gap between gross rebate and net rebate is rarely the contracted pass-through percentage. It is usually a few percentage points lower, and the difference is captured in administrative-fee or data-licensing categories that the PBM classifies outside the rebate definition.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> the amendment window is rarely used by plan sponsors. Most plans wait until renewal and absorb the H1 finding for two more quarters. The amendment window costs nothing to invoke and forces the PBM into a documented response — which is itself the most valuable record you can bring to renewal six months later.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> most RFP scoring methodologies score against headline pricing, not normalized net cost. The PBMs know this; the headline number is engineered to win the RFP, not to match what the plan will actually pay.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> aggregate PBM compensation typically exceeds the headline administrative fee by a meaningful multiple. The other four mechanisms are where the rest sits. Plan sponsors who only track administrative fees see a small fraction of total PBM compensation.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> GER guarantee misses go unreconciled on most plans because the plan sponsor never calculates the comparison. The remediation clause is in the contract; the trigger is the audit.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> the manufacturer copay card crediting category is rarely flagged correctly. Copay accumulator and copay maximizer programs depend on accurate flagging at the claim level. If the flag is missing or wrong, the program does not capture the manufacturer dollars correctly.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> most contracts have at least four required disclosures, but plan sponsors typically receive only one (the standard quarterly report). The other three are obligations the PBM has but rarely fulfills proactively.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> most plan sponsors have decisions, but few have decision documentation that would survive a fiduciary audit. The decision happened; the prudent-process record did not.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> most termination-clause negotiations never result in termination. But a strong termination provision changes every other negotiation. When the PBM knows you can leave efficiently, they negotiate pricing, rebates, and service levels with more urgency. Vague termination language is its own concession.",
    ...
    },
    {
        ...
        "pattern_callout": "<strong>Across hundreds of PBM contract reviews and audits annually at PBS:</strong> the first renewal meeting is the frame-setting meeting. Plan sponsors who walk in with documentation set the frame; plan sponsors who walk in with the PBM's renewal deck inherit the PBM's frame. The deck the PBM brings is engineered. The five items above are the counter-engineering.",
