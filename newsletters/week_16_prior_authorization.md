...
> **Animated video carousel spec relocated:** The "5 Contract Clauses That Cost You Money" animated video build spec plus the eight alternative video concepts (Stat Reveal, Flow Chart, List, Comparison Reveal formats) that previously lived in this section have been moved to Week 17 (`week_17_carve_out_decision.md`, Post 57 Tuesday), where the animated video is now scheduled. Both assets were produced April 2026. Week 16 Tuesday uses the static Library 01 redline carousel above; Week 17 Tuesday uses the animated video carousel with the five different clauses (Covered Drug, Network Pharmacy, Generic Equivalent, Audit Period, Rebate Guarantee).
...
- [ ] Tuesday: Post 53 - "The Five Clauses That Decide Your PBM Contract" Library 01 Carousel published at 8:30 AM (PBM Contracts pillar - different from newsletter)
...
- [x] Carousel (7 slides, 1080 x 1350 px): "The Five Clauses That Decide Your PBM Contract" Library 01 — contract-document redline aesthetic (Post 53, Tuesday). PRODUCED April 2026. PBS logo retained per series exception.
