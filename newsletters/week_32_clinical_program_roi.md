...
> A clean, flat corporate infographic, 1080 x 1350 pixels (4:5 vertical), on a white (#FFFFFF) background with generous margins, designed as a single-panel "reported versus verified" comparison of PBM clinical program savings. Top: a full-width Primary Blue (#015880) header band about 170px tall containing the two-tone title in IBM Plex Sans SemiBold (clinical register, never a condensed or poster face): "Clinical Program ROI" in white (#FFFFFF, about 48pt) with "Reported vs. Verified" in Accent Blue (#A7E0FA, about 34pt) directly beneath, left-aligned, and a small white outline magnifying-glass icon at the right of the band. Body, top block: two large side-by-side stat cards, the left card labeled "REPORTED" in Gray (#4D4D4D) IBM Plex Sans with the figure "$4.2M" in Primary Blue IBM Plex Mono tabular figures (about 64pt) and a caption "what the PBM reported in clinical savings", the right card labeled "PROGRAMS" with the figure "6" in Primary Blue IBM Plex Mono (about 64pt) and a caption "6 methodologies. 6 different assumptions." Body, middle block: two compact example rows, each a rounded card with a tag pill and a Gray annotation, row one tag "PA" annotation "counts full cost of denied drugs, not net savings", row two tag "DUR" annotation "counts every alert, most overridden as clinically irrelevant". Body, lower block: a single rounded score-band strip split into three traffic-light segments with white IBM Plex Sans SemiBold labels and IBM Plex Mono tabular-figure thresholds, a Green (#2E7D32) segment "12/20+  Verified", an Amber (#F5A623) segment "below 12/20  Audit", and a Red (#C0392B) segment "no methodology  Do not trust", with a small note beneath "Programs below 12/20 need an independent audit." Below everything, a slim Accent Blue (#A7E0FA) footer bar holds "Verified is not Reported. One request: the methodology per program." in Primary Blue IBM Plex Sans SemiBold. Render every number, dollar figure, and score in IBM Plex Mono, tabular figures. Large, high-contrast, thumbnail-legible type throughout, nothing beyond the two stat cards, two example rows, and one score strip competing for attention. Reserve empty space at the bottom-right for a logo (do not draw one), and place a small footer line "rxbs.org" in IBM Plex Mono Gray (#4D4D4D) at the bottom-left. No grid-pattern background, no photographs, no people, no real logos, no PBM logos. Color palette strictly: white (#FFFFFF), Primary Blue (#015880), Accent Blue (#A7E0FA), Gray (#4D4D4D), plus the traffic-light accents Green (#2E7D32), Amber (#F5A623), Red (#C0392B).
...
Even the programs that genuinely work deserve the same test. Copay maximizers are the clearest example: run well, they capture manufacturer assistance that would otherwise go uncollected and turn it into real plan savings, and we use them in client work. But the dollars are large and the economics are usually undisclosed. In Johnson & Johnson's lawsuit against the maximizer vendor SaveOnSP, Stelara copay assistance ran about $1,200 per script for non-enrolled patients and about $4,300 per script for enrolled ones, with nine figures in dispute. Money at that scale moving through a program on your plan deserves a stated methodology, a documented vendor fee, and a verifiable answer to one question: what share of the captured dollars reached the plan?
