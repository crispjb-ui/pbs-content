...
_Re-ranked Jul 20, 2026: the clean 9:16 reach test is STILL OPEN (the W26 9:16 shipped with dead-zone render defects → compromised read), so the top pick is a proven-shape reveal at the RIGHT length (15-25s) to give the cleanest reach read. V9 (FTC-Caremark settlement) leads on freshness + renewal-season timeliness; V1 (the canonical 17.8K breakout shape) is the reach-test candidate. Reveal-shaped scripts lead (the measured organic engine, 5.5-17.8K static; vocabulary decoders ran 595-789 in the same summer weeks); every script targets the **15-25s completion zone** for the short cut. The updated 2026 retention curve (below) says a 15-25s clip needs ~50-60% completion vs the W26 clip's ~44% at 32s — shorter + value-dense._

| # | Hook (first 3s) | Shape | Status | Platforms |
|---|------------------|-------|--------|-----------|
| V9 | "The FTC just made the biggest PBM stop selling spread pricing. Here's the catch." | Reveal-reshaped news (FTC-Caremark settlement; gap = fixes the offering, not signed contracts) | scripted, ready — **timely, film in the Sep renewal window** | LI 9:16 + short ~25s + X/Shorts |
| V1 | "Your PBM passes through 100% of rebates. The middleman it owns does not." | Shocking hidden-structure (offshore rebate aggregator/GPO) — **the clean-9:16 reach-test candidate at the ~22s cut** | scripted, ready | LI 9:16 (long ~55s) + short ~22s |
| V7 | "The FTC studied the generics your PBM marks up most. More than 1 in 5: over 1,000 percent." | Reveal + dollar comparison (specialty generic markups) — strongest new figure | scripted, ready | LI 9:16 + short ~22s |
...
_Origin V3 stays in the bank but off the top-5: reveals lead while the reach test is open, and origin is capped 1/month (underperforms on X, strong on LinkedIn/Reels)._
...
### V7 — Specialty generic markups over 1,000% (strongest new figure) _(added Jul 20, 2026)_
- **Hook A (0-3s):** "The FTC studied the generic drugs your PBM marks up most. More than one in five: over 1,000 percent."
- **Hook B (retest):** "Not brand drugs. Generics. Marked up over 1,000 percent, at the pharmacy your PBM owns."
- **Beats (short ~22s):** (1) promise: "generics are the cheap part of your plan." (2) loophole: at their OWN pharmacies the FTC found ~two-thirds of specialty generics marked up 100%+, and more than 1 in 5 over 1,000%. (3) countable payload + cutaway: "$7.3 billion above what the drugs cost them, 2017-2022" (stat/equation bar). (4) anchor: "we run the claim-level markup comparison as standard audit work, hundreds of contracts a year." (5) CTE: "Ask what share of your specialty generics filled at a pharmacy your PBM owns, and at what markup."
- **Shape:** reveal + dollar comparison. **Source:** `shocking_fact_bank.md` #2 (FTC Second Interim Staff Report, Jan 2025; re-verify at post). **Status:** scripted, ready. **Scheduling guardrail:** same FTC-specialty-markup family as V5 (owned-pharmacy steering), V10 (NADAC gap), V11 (which conditions) — never two of that family in one week; W34's specialty-week Thursday reveal draws from this fact, so run the video 2-3 weeks off W34.

### V8 — The formulary is a storefront (600+ exclusions / private-label) _(added Jul 20, 2026)_
- **Hook A (0-3s):** "Your PBM's 'preferred' formulary excludes more than 600 drugs. That list isn't clinical."
- **Hook B (retest):** "They dropped Humira and put their own private-label biosimilar in its place. On purpose."
- **Beats (short ~24s):** (1) promise: "the formulary is built for your members' health." (2) loophole: each big-3 now excludes 600+ drugs (an all-time high), increasingly replacing them with the PBM's OWN private-label product. (3) payload + cutaway: "600+ exclusions" + the Humira→private-label-biosimilar swap. (4) anchor: "we compare a plan's formulary to the PBM's standard book, hundreds a year, and the 'custom' one usually isn't." (5) CTE: "Ask how your formulary differs from the PBM's standard exclusion list, and who makes the replacement drug."
- **Shape:** reveal. **Source:** `shocking_fact_bank.md` #6 (Drug Channels / Adam Fein, Jan 2026; refresh the count each plan year). **Status:** scripted, ready. **Scheduling guardrail:** W36's formulary-storefront Thursday reveal uses this fact — run the video 2-3 weeks off W36.

### V9 — The FTC made them stop selling it. Your contract still has it. (FTC-Caremark settlement) _(added Jul 20, 2026 — timely)_
- **Hook A (0-3s):** "The FTC just made the biggest PBM stop selling spread pricing and rebate games. Here's the catch."
- **Hook B (retest):** "The government banned the tricks. Only on new deals. The one you're about to renew still has all of them."
- **Beats (short ~25s):** (1) news peg: the FTC settled with CVS Caremark (Jul 15, 2026) — delinks fees from list price, moves off rebate guarantees + spread pricing, discloses broker/consultant comp; Express Scripts took the same terms Feb 2026. (2) the reveal/loophole: the settlement fixes the PBM's STANDARD OFFERING going forward — it does NOT rewrite the agreements already signed. (3) self-relevance: "every provision they just agreed to stop offering is still sitting in the contract you renew this fall." (4) anchor: "we read hundreds of these contracts a year; the banned terms are still in most of the live ones." (5) CTE: "Before you renew, ask which of the settled practices are still in YOUR contract."
- **Shape:** reveal-reshaped news (the gap the news exposes, not the news itself). **Source:** `shocking_fact_bank.md` pipeline (FTC/Caremark settlement, ftc.gov press release Jul 15, 2026; re-verify at post — 30-day public-comment window open, OptumRx consent still pending). **Status:** scripted, ready. **Scheduling guardrail:** LinkedIn-first — the settlement is woven into W28/W29 text posts, so if filmed for a Wednesday keep it distinct from that week's Thursday reveal; do not scoop a reserved reveal. **⏱ Timeliness:** news currency decays — best in the **Sep 2026 renewal window** (90-day Jan-1 notice) as "they made them stop offering it; your contract still has it"; re-verify settlement status before shipping.

### V10 — The public price you've never been shown (NADAC gap) _(added Jul 20, 2026)_
- **Hook A (0-3s):** "There's a public price for what a generic costs a pharmacy. You've probably never seen it on a claim."
- **Hook B (retest):** "The gap between the public price and what your PBM bills you grew 42 percent a year. Compounding."
- **Beats (short ~22s):** (1) promise: "you can see what you pay." (2) loophole: NADAC is public, but the amount PBM-owned pharmacies bill ABOVE it grew 42% compound annual (2017-2021) and never shows on your summary. (3) payload + cutaway: NADAC vs billed, two numbers on one claim. (4) anchor: "we pull both numbers on the same claim; the gap is the finding." (5) CTE: "Ask to see NADAC and your billed amount on the same generic claim."
- **Shape:** reveal. **Source:** `shocking_fact_bank.md` #7 (FTC Second Interim Staff Report, Jan 2025). **Status:** scripted, ready. **Scheduling guardrail:** same FTC-report source family as V5/V7/V11 — space out; technical, so best paired with a pricing / mid-year-claims week rather than the top of the shoot-list.

### V11 — The markup scales with how sick your member is (human angle) _(added Jul 20, 2026)_
- **Hook A (0-3s):** "The generics your PBM marks up the most aren't lifestyle pills. They're the ones for leukemia, MS, transplant, and HIV."
- **Hook B (retest):** "The sicker your member, the bigger the spread. That's not a coincidence."
- **Beats (short ~24s):** (1) promise: "markups are random." (2) reveal: the FTC found the biggest specialty-generic markups landed on generics for leukemia (Gleevec), MS (Ampyra), transplant (Myfortic), renal (Sensipar), and HIV. (3) payload + cutaway: the named conditions + "51 drugs, 882 NDCs." (4) anchor: "we see which of a plan's high-cost claims carry the biggest markup, and it tracks the sickest members." (5) CTE: "Ask where your largest specialty markups land, by condition."
- **Shape:** reveal (the human/condition angle broadens reach beyond the finance audience). **Source:** `shocking_fact_bank.md` #8 (FTC Second Interim Staff Report; Pharmacy Times). **Status:** scripted, ready. **Scheduling guardrail:** same FTC-specialty-markup family as V7/V10 — the human angle is the differentiator, so if V7 runs hold V11 ~4-6 weeks; never cluster the FTC-markup family in one window.
...
## Current video best practices (research-backed, refreshed Jul 20, 2026)
_Maintained by `/video-research`; measured PBS data overrides where it conflicts._
- **9:16 vertical is the format** — fills 100% of the mobile screen (~73-91% of LinkedIn B2B viewing is mobile); **LinkedIn now reportedly beats YouTube for B2B video** and video is the platform's fastest-growing / highest-engagement format. Reinforces the LinkedIn-9:16-first priority. **CONFIRMED** (multiple 2026 sources).
- **LinkedIn video +69% YoY performance vs 2024** (vendor-aggregated) — video is over-indexed on the feed right now, so the format tailwind is real even as PBS's own reach test stays open. **DIRECTIONAL** (single-vendor figure; direction corroborated).
...
- **Completion is the algorithm lever — and the 2026 curve is now more granular than a flat 70%:** ~70% survive the 3s mark, ~60% at 15s, ~50% at 30s; **a sub-30s clip should clear ~60% completion, ~70% completion → ~3.5x more likely to be recommended.** So a 15-25s PBS reveal needs ~50-60% completion, which the W26 9:16 (~44% at 32s) missed partly on length. **Shorter + value-dense beats long.** **CONFIRMED** (multiple 2026 sources).
- **Captions mandatory** (≈85% watched sound-off, up from the ~75% prior read); burn them in. **CONFIRMED.**
- **"Edutainment" is the winning LinkedIn-video frame in 2026** — educational value wrapped in storytelling + strong visuals + specificity. **Brand-fit: PARTIAL.** PBS takes the storytelling/visual/specificity half (that's the reveal formula) and REJECTS the humor/hype half — the clinical-credibility register + the Humanize Check ban on influencer voice govern. The extractable rule: lead with a concrete story/scene, dramatize with the cutaway, never "make it fun." **DIRECTIONAL.**
...
- **Competitor / like-brand video teardown (Jul 20, 2026 sweep):** the DIRECT lane (independent PBM auditors / pharmacy-benefits consultants — ARMSRx, Innovative Rx Strategies, PillarRx, APC, plus the big consultancies Aon/Milliman/Baldwin) remains **corporate-site / firm-page only, no notable personal 9:16 short video** — the white space holds and Ginny's talking-head authority lane is still under-served. **CONFIRMED** (search sweep, no notable short video surfaced). **But the one video lane that IS active in the PBM-transparency niche is the podcast/interview clip** — e.g., Antonio Ciaccia (3 Axis Advisors / 46brooklyn) + AJ Loiacono (Capital Rx / Judi Health) on the Astonishing Healthcare podcast and the 3 Axis media page (long-form audio/interview, clipped). **Implication:** PBS's Mode B repurpose (podcast clips) competes in the niche's one live video lane, while Mode A scripted talking-head is greenfield. Reinforces the podcast-outreach + `/clip-podcast` priority. **DIRECTIONAL.** Benefits-broker/advisor thought-leaders are being pushed toward short-form video by 2026 LinkedIn guidance, but no dominant advisor short-video creator surfaced — that lane is still forming.

## Hook & retention playbook (research-backed, added Jul 4, 2026 — refreshed monthly by `/video-research`)

_The current best practices for the first 3 seconds and for holding watch-through, checked across multiple 2026 sources and vetted for PBS's B2B voice (no influencer hype; the Humanize Check bans "in the next 90 seconds I'll show you"). Where these conflict with PBS's measured data, the measured data wins. Every rule has a home: script rules run through `/clip-podcast` + `/video-research` + `/build-week`; render rules are implemented in `Clip.tsx`; verification is `/video-qc` + the runbook Phase 4 gate._

**Hook (0-3s) — the gate that decides distribution:**
- **One promise per hook.** One clear claim, present tense, active voice — never two. Bold claim / curiosity gap / challenged assumption are the top-performing structures, which is exactly PBS's promise-then-loophole reveal hook: the reveal formula already IS the 2026 hook meta. **CONFIRMED** (multiple 2026 sources).
- **Spoken + on-screen together.** The text hook reinforces the spoken line (60-80%+ watch muted); high-contrast block text, on-screen ≥2s, inside safe margins. Already the hook-panel spec. **CONFIRMED.**
- **Cold-open on tension; never a logo/intro card.** Frame 0 is already mid-energy. **CONFIRMED.**
- **Motion from the first frames.** A pattern interrupt inside the first 5s lifts average retention ~23% vs a static open — the hook panel's staggered/spring entrance is that interrupt; QC verifies it survived the render (t0.2 vs t2.0 frames must differ). **CONFIRMED (direction multi-source; one source quantifies).**
- **Cold-open TEASER (selective, not every clip):** when the clip's strongest beat lands LATE in the footage, play that beat as the first ~1.5-3s (hook text unchanged on top), then cut back to the beginning and run the clip through. Renderable via the `coldOpen` prop in `Clip.tsx`. **Use selectively:** only when the money line isn't already near the front — on a 15-25s clip that opens strong, a teaser just makes the viewer hear the same line twice with no gain. **DIRECTIONAL (widely used pattern; PBS A/B via v1-vs-teaser renders).**
- **Deliver the FULL hook by ~2-2.5s** (a half-second buffer before the 3s gate) — pacing that signals "I respect your attention," which itself lifts completion. Don't wind up to the claim; open ON it. **CONFIRMED** (Jul 2026 sources; TikTok for Business: **63% of the highest click-through videos hook within the first 3s**).
- **Benchmark: ≥70% of viewers survive the 3s mark, ~60% at 15s, ~50% at 30s** ("viewed vs swiped" ≥75% where exposed). LinkedIn only exposes avg watch time, so track completion % (avg watch ÷ clip length) as the proxy; a 15-25s clip is on-target at ~50-60% completion. **CONFIRMED** (multiple 2026 sources).

**Retention (3s → end):**
- **Pattern-interrupt cadence ≤5s.** Something changes visually every ~2-5s: the karaoke word-reveal is a per-word micro-interrupt, the v2 punch-in fires on every caption boundary (~2-4s), and each clip carries ≥1 full-screen cutaway. A 15-25s PBS clip built to spec already meets the cadence — the rule exists so nothing strips these out. **CONFIRMED.**
- **Visual break every 20-30s of talking head.** At PBS clip lengths: ≥1 cutaway per clip always; 2-3 on the ~60-75s LinkedIn long cut. **CONFIRMED.**
- **Mid-clip re-engagement beat (~40-65% through; clips >25s):** one short open-loop line naming the payoff still ahead — lifts retention 4-8pp. Renderable as the `midHook` chip in `Clip.tsx` ("Watch where the $20 goes" on clip1v2 is the worked example) or spoken in the script. **B2B guardrail: name the payload, never hype** ("the biggest fee is last," not "wait for it!"). Not needed on tight sub-25s clips whose cutaway already lands mid-clip. **DIRECTIONAL (mechanism multi-source; the 4-8pp figure single-source).**
- **Strongest payload item LAST, and say so.** Ordering the countable payload weakest→strongest and flagging it is the B2B-safe open loop. Script-level rule for every countable-payload clip.
- **Loop-friendly end (Shorts/Reels/TikTok only):** end on a motion/frame that chains into the opening so the rewatch feels seamless. Not for the LinkedIn cut (the end card carries the CTA there). **DIRECTIONAL.**

**Testing discipline:**
- **Draft TWO hook variants per scripted concept** (the bank carries both; the shoot uses one, the alternate is the retest). Judge on the 3s-hold / completion read in the shipped log; replicate the winning structure, then test again. `/video-research` runs this loop monthly. PBS sample sizes are small — treat single reads as directional. **CONFIRMED as practice.**

_Sources (Jul 4, 2026 pass): [OpusClip — Shorts hook formulas](https://www.opus.pro/blog/youtube-shorts-hook-formulas) · [Virvid — first-3-seconds hooks](https://virvid.ai/blog/first-3-seconds-hook-faceless-shorts-2026) · [Joyspace — pattern interrupts](https://joyspace.ai/pattern-interrupt-reset-attention-span) · [Edición Video Pro — retention editing](https://edicionvideopro.com/en/video-workflow-tutorials/audience-retention-how-to-edit-videos-that-keep-viewers-hooked/) · [Overseeros — retention loops](https://www.overseeros.com/blog/youtube-retention-loops) · [Visla — LinkedIn video 2026](https://www.visla.us/blog/guides/linkedin-video-in-2026-whats-working-and-how-to-make-it/) · [Teleprompter — LinkedIn video statistics](https://www.teleprompter.com/blog/linkedin-video-statistics)_
...
## Changelog
### 2026-07-20 (monthly video research pass)
- **Ran the Jul 2026 hook/retention + platform-video research pass (adversarially verified).** Refreshed the "Current video best practices" and "Hook & retention playbook" sections: added the **granular 2026 retention curve** (~70% past 3s / ~60% at 15s / ~50% at 30s; sub-30s clip → clear ~60%; **the W26 9:16 missed partly on length** at ~44% over 32s — CONFIRMED, multiple sources); the **hook fully delivered by ~2-2.5s** with a half-second buffer (CONFIRMED; TikTok for Business: 63% of highest-CTR videos hook in the first 3s); **LinkedIn video +69% YoY** vs 2024 (DIRECTIONAL); captions now ~85% muted (up from ~75%); and the **"edutainment"** 2026 frame with a **PARTIAL brand-fit verdict** — PBS takes the storytelling/visual/specificity half, rejects the humor/hype half (clinical register + Humanize Check).
- **Competitor / like-brand video teardown:** the direct lane (PBM auditors / pharmacy-benefits consultants — ARMSRx, Innovative Rx Strategies, PillarRx, APC, Aon, Milliman, Baldwin) is still **corporate-site only, no notable personal short video** (white space holds — CONFIRMED). **The one active video lane in the niche is the podcast/interview clip** (Ciaccia/Loiacono on Astonishing Healthcare; 3 Axis media page — DIRECTIONAL), which is exactly PBS's Mode B `/clip-podcast` lane; Mode A scripted talking-head remains greenfield.
- **PBS own-results read:** the **clean 9:16 reach test is STILL OPEN** — the only 9:16 shipped (W26) carried the six dead-zone render defects (fixed in `Clip.tsx` Jul 1) and was out-reached 8:1 by the same week's static reveal; no shape fatigue to flag (only 2 ships, different shapes/formats). The gap is a process gap (re-test on a Phase-4-clean render), not a shape retirement.
- **Bank auto-updates:** re-ranked the Active shoot-list (V9 FTC-settlement first on freshness + Sep renewal-season timeliness; V1 offshore-aggregator as the clean-9:16 reach-test candidate at the ~22s cut; V7 strongest new figure next). **Added 5 new reveal-built scripted concepts** from unused fact-bank material — **V7 specialty-generic >1,000% markups (#2), V8 formulary-as-storefront (#6), V9 FTC-Caremark settlement (pipeline, VERIFIED Jul 15 — timely), V10 NADAC public-price gap (#7), V11 markup-scales-with-sickness human angle (#8)** — each with two hook variants + a same-family scheduling guardrail. **No retirements** (no fatigue signal).
- **Proposed to OPEN_ITEMS (judgment, not auto-applied):** gate the scale-to-weekly Wednesday video cadence on a clean 9:16 reach read, and weight Mode B podcast clips over net-new Mode A scripts until that read lands. Related to the standing Jul 18 owned-YouTube proposal.
- _Sources (Jul 20 pass): [YansMedia — LinkedIn video specs 2026](https://www.yansmedia.com/blog/linkedin-video-ad-specs-guide) · [Neal Schaffer — LinkedIn video 2026](https://nealschaffer.com/linkedin-videos/) · [dataslayer — LinkedIn algorithm 2026](https://www.dataslayer.ai/blog/linkedin-algorithm-february-2026-whats-working-now) · [Hansen — 3-second hook 2026](https://hansencommerce.com/insights-tiktok-hook-3-seconds) · [OpusClip — Shorts length/retention](https://www.opus.pro/blog/ideal-youtube-shorts-length-format-retention) · [Teleprompter — short-form strategy 2026](https://www.teleprompter.com/blog/short-form-video-strategy) · [3 Axis Advisors media](https://www.3axisadvisors.com/media) · competitor sweep (ARMSRx / Innovative Rx Strategies / PillarRx / APC — no notable short video)._
...
### 2026-07-02 (gating-fix: aspect-string → dimension-based `vertical`)
- The six 9:16 fixes above were initially gated on `clip.aspect === "9x16"`. That was a **bug**: the render scripts (SHRM manifest) assign each clip ONE fixed aspect and render it into BOTH formats, so a clip manifested `4x5` would render a 9:16 output that skipped every fix (Ginny reported "ran successfully but I don't see any differences" — the clips she was checking were 4:5-manifested). Corrected the gate to a **dimension-based** flag `const vertical = height / width > 1.5;` and switched every chrome position/size from `aspect ===` to `vertical ?`, so the safe-zone treatment applies to any output whose actual composition is portrait, regardless of the clip's manifest aspect. The verified 4:5 path is still untouched (its `height/width` is ~1.25, below the 1.5 threshold). This is the version that produced visible differences on re-render. Source: SHRM re-render review with Ginny.
