# Week 31 Newsletter Bundle: The PBM RFP Process
## August 3-7, 2026
...
> A clean, flat corporate infographic, 1080 x 1350 pixels (4:5 vertical), on a white (#FFFFFF) background with generous margins, designed as a vertical five-phase process timeline for a PBM RFP. Top: a full-width Primary Blue (#015880) header band about 170px tall containing the two-tone title in IBM Plex Sans SemiBold (clinical register, never a condensed or poster face): "The PBM RFP Timeline" in white (#FFFFFF, about 46pt) with "It Takes Longer Than You Think" in Accent Blue (#A7E0FA, about 30pt) directly beneath, left-aligned, and a small white outline clock icon at the right of the band. Body: a single vertical Accent Blue (#A7E0FA) spine line running top to bottom with five evenly spaced phase nodes, each node a filled Primary Blue (#015880) circle carrying a white IBM Plex Mono tabular-figures week range, and to the right of each node a rounded card with the phase name in Primary Blue IBM Plex Sans SemiBold (about 26pt) and a short annotation in Gray (#4D4D4D) IBM Plex Sans. The five phases top to bottom: node "WEEKS 1-2" card "RFP Development" annotation "A strategic document, not a template download."; node "WEEKS 3-6" card "Distribution + Responses" annotation "Give PBMs 3 to 4 weeks. Less means rushed answers."; node "WEEKS 7-8" card "Normalize + Score", this one card outlined in Red (#C0392B) with a Red annotation "This is where most evaluations fail."; node "WEEKS 9-10" card "Finalist Presentations" annotation "Watch for vague answers."; node "WEEKS 11-16" card "Contract Negotiation" annotation "Every provision matters. The contract defines 2 to 3 years." Below the timeline, a slim Accent Blue (#A7E0FA) footer bar holds "Total: 4 to 6 months from RFP to go-live." in Primary Blue IBM Plex Sans SemiBold, with "4 to 6" in IBM Plex Mono tabular figures. Render every week range and number in IBM Plex Mono, tabular figures. Large, high-contrast, thumbnail-legible type throughout, nothing beyond the five phases and the footer competing for attention. Reserve empty space at the bottom-right for a logo (do not draw one), and place a small footer line "rxbs.org" in IBM Plex Mono Gray (#4D4D4D) at the bottom-left. No grid-pattern background, no photographs, no people, no real logos, no PBM logos. Color palette strictly: white (#FFFFFF), Primary Blue (#015880), Accent Blue (#A7E0FA), Gray (#4D4D4D), plus a single Red (#C0392B) alert accent.

---

### Article Meta

**SEO Title:** PBM RFP: 30 Questions with Answer Scoring Rubrics | Benefit Blind Spots
**SEO URL Slug:** pbm-rfp-questions-answer-scoring
**Meta Description:** PBM RFP responses are designed to win evaluations, not reveal true cost. 30 questions with scoring rubrics that cut through the noise.
**Tags:** PBM RFP, contract evaluation, pricing guarantees, self-funded employers, pharmacy benefits
...
## The Pharmacy Benefits Briefing - Issue #26
### PBM RFP Briefing

**Publish:** Monday, August 3, 2026 at 7:45 AM EST
**Length:** ~400 words
...
Here is the problem: PBM RFP responses are designed to win evaluations, not to reveal true cost. Standard RFP templates ask questions PBMs are prepared to answer in ways that make every response look competitive. The questions are not wrong. They are insufficient.

The fix is not a longer RFP. It is better questions with evaluation criteria that force specificity. When a PBM answers "industry standard AWP," the follow-up should be: "specify the source and commit contractually." When they report "clinical savings," the follow-up should be: "provide the methodology and a sample calculation."

Thirty questions, organized in six categories, with scoring rubrics that distinguish between committed answers and vague ones. That structure normalizes responses across PBMs and reveals which proposals are genuinely competitive.

The best brokers and consultants already layer this level of specificity on top of standard templates. If yours does not, this framework gives you the questions to add.

---

This week's Benefit Blind Spots includes a **PBM RFP question bank**: 30 questions with answer scoring rubrics (0-3 per question, 90-point scale). That question bank is exclusive to the Substack: [SUBSTACK URL]
...
```
You send a 50-page RFP, your PBM sends a 50-page response, and neither document tells you what you will actually pay.
