...
| Channel Pricing | "What We See When We Audit Channel Pricing" (W18 Field Note shipped; earlier working title "Auditing Your MAC Margin: Three Channels, One PBM" superseded) | The Channel Pricing Audit Worksheet decoded the channel-pricing terms. The Field Note runs the same audit on the MAC list itself: the per-channel margin spread that the contract's MAC clause is silent on. |
