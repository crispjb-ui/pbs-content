...
**⚠ RED-TEAM FLAG 1 — ✅ RESOLVED (Jul 21, 2026):** Ginny ATTESTED the five criteria + "We accept no PBM revenue" are true as written (`standards_independence_attestation.md`, attested same day). **CLEARED TO PUBLISH** (flag 3, the "or advisor" phrase, rides the same attestation — she read the criteria language in the walk).
