...
- **Slide 2 (Express Scripts / Cigna):** the full Lane 1 scene, large and clean: US pin → dotted flight arc + plane over the ocean strip → "ASCENT · SWITZERLAND · 2019" passport stamp → red FEE scissor → smaller, tired bill at the Gray "YOUR PLAN" box → Primary Blue tag "then 100% pass-through, of what's LEFT".
- **Slide 3 (OptumRx / UnitedHealth):** same layout → "EMISAR · IRELAND · 2021".
- **Slide 4 (CVS Caremark):** the long cross-country CAR RIDE (winding road + small car across the US, no plane/ocean) → "ZINC · UNITED STATES · 2020" → red FEE → smaller, road-weary bill; Gray note "Zinc is US-based, still a separate company that takes a cut."
