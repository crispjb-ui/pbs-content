...
Without these two subsections the LinkedIn newsletter cannot be scheduled cleanly — Ginny needs to pick the title and paste the feed announcement when LinkedIn prompts. When drafting a new week file from scratch, include both subsections automatically; backfill prior weeks as bandwidth allows. W22 forward is the lock-in standard.
