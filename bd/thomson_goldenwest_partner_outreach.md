# Partner Outreach — Mike Thomson / Goldenwest Health Insurance
...
## Tier / rule
- Funnel tier = **PARTNER** (Broker/Consultant). Per CLAUDE.md "brokers as partners" + `role_funnel_plan.md`: **never pitch a broker an audit.** Track = referral/partnership; PBS is the independent bench he brings in; he stays relationship owner. Metric = clients referred.

## Objective
Open a peer relationship with the Rx-focused consultant. One soft door: PBS as the independent pharmacy/PBM contract + claims audit bench that deepens his existing Rx strategy for clients. Relationship, not a close.

## Hooks to deploy (all real)
- He owns Rx strategy already → frame PBS as the **specialist bench that goes deeper** (contract/claims forensics), not a gap-filler. Respect his expertise.
- Strong ICP overlap: mid-to-large **self-funded** groups + **captives** = exactly where independent PBM audits land.
- Proprietary anchor: "We review hundreds of PBM contracts a year."
- His bulk download = genuine, did-the-work engagement; acknowledge lightly.

## Cautions
- **No audit pitch to Mike.** Behind brokers, never around. Frame as deeper specialist hands; he owns the client.
- Don't overclaim or condescend, he's a 25-year Rx-savvy consultant. Peer tone.
- **No fabricated numbers.** Realized-savings track record only if natural, labeled "results vary by plan." Draft omits it on first touch.
- Captives angle is a real differentiator (pharmacy inside a captive is often under-audited), use as a talking point if he engages, not in the cold open.
...
1. The PBM audit bench behind your Rx strategy
2. From one pharmacy-cost nerd to another
3. Saw your toolkit downloads, a note from a pharmacist
...
looked up Goldenwest. A 25-year benefits consultant who owns the Rx
strategy for self-funded and captive groups is exactly who those
tools are for.

I am a pharmacist, and PBS does one narrow thing: we review hundreds
of PBM contracts a year and run independent pharmacy contract and
claims audits. We work behind brokers, never around them.

No pitch. You already run real Rx work; we are just the deeper bench.
If a client's high-cost pharmacy spend or PBM contract ever needs an
...
- Mark status = "contacted" in the PBS Toolkit Leads sheet.
- Relationship-first; referrals follow. If he engages, the captive-pharmacy and mid/large self-funded angles are the strongest discovery threads.
