...
| Tue May 26 | Morning | Roundup Drafting | Wed Substack Roundup `roundup_2026_05_26.md` auto-generates. **LEAD STORY MUST BE: CVS Health 340B lawsuits (Mount Sinai / U Michigan / U Kansas, filed May 21, ~$250M alleged diversion).** **#2 STORY MUST BE: Pennsylvania Insurance Department PBM study released May 21 under Act 77** (Freedman Healthcare analysis of Caremark / Express Scripts / Navitus / OptumRx / Prime Therapeutics; key findings: steering limited, spread pricing decreasing under state pressure, NADAC + $10.49 would redistribute $14M to independent retail pharmacies = 0.3% of fully-insured drug costs). **#3 STORY MUST BE: CVS sues Tennessee to block PBM divestiture law (filed May 22 in U.S. District Court for the Middle District of Tennessee against TN Board of Pharmacy and Attorney General).** CVS argues the law unconstitutionally restricts interstate commerce and is preempted by federal law; cites the parallel Arkansas law blocked by federal judge July 2025. Bill sponsor: state Sen. Bobby Harshbarger, R-Kingsport. CVS Caremark managed 1/3 of all U.S. prescription drug claims in 2023; top 3 PBMs controlled 80% of national market as of 2021. **Frame the three together as the 48-hour arc:** May 21 hospital suits show where extraction happens (vertical integration); PA study shows where state pressure has already reshaped traditional spread pricing; CVS TN countersuit shows PBMs litigating to protect the vertical-integration model the other two stories expose. PBS's interpretive layer is the only place this connection gets made for plan sponsors. If automation surfaces different leads, manually re-anchor. Sources for #1: Fierce Healthcare, AJMC, Modern Healthcare, Fox Business, amNewYork, Becker's. Source for #2: pa.gov Insurance Department press release May 21, 2026 + linked study PDF. Source for #3: Six Rivers Media (Joy Mazur, May 22, 2026). | [ ] |
...
| Wed May 27 | 7:30 AM | Substack | Weekly Roundup "What Crossed My Desk This Week" — **verify trifecta before publish: lead = CVS 340B lawsuits / #2 = Pennsylvania Act 77 PBM study / #3 = CVS sues Tennessee to block PBM divestiture law. If auto-routine overwrote any, restore manually.** W20 history shows automation has overwritten pre-curated leads before. | [ ] |
...
| Fri May 29 | Afternoon | Substack Notes | Note #4 - Industry observation | [ ] |
| Sat May 30 | - | Substack Notes | Note #5 - Engage with another publication | [ ] |
...
This section is the operational source-of-truth for the Wix work this week. One toolkit ships this week (monday deep dive: Quarterly Reporting Checklist); it becomes a row in the Wix `Toolkits` Data Collection at `rxbs.org/toolkit/quarterly-reporting` and gets a 5-email welcome sequence wired through the existing Wix Automation. Companion file: `email_gated_toolkit/toolkit_dataset.md`.

---

## Toolkit 1 — Monday Deep Dive · Quarterly Reporting Checklist
...
- [ ] Upload `templates/documents/week_21_quarterly_reporting_checklist.pdf` to Wix Media Manager
...
- [ ] Verify `rxbs.org/toolkit/quarterly-reporting` renders correctly
...
### Quarterly Reporting Briefing

**Publish:** Monday, May 25, 2026 at 7:45 AM EST
...
Three actions this quarter: pull your last report and run it against the 15-line list. Send the gap list to your broker. Add the gap list to your renewal redline.

---

This week's Benefit Blind Spots includes the full **15-line quarterly reporting checklist** as a printable plan-sponsor handout, plus the protective contract language that turns the missing items into standing reporting deliverables. The checklist and the contract language are exclusive to the Substack: [SUBSTACK URL]
...
**Pillar:** Broker/Consultant Resources (different from Monday's Transparency & Industry Education / Quarterly Reporting topic)
...
### "Three nonprofit hospital systems sued CVS Health on May 21." 340B Vertical-Integration News Critique (Text)
...
- **Hook:** "Three nonprofit hospital systems sued CVS Health on May 21. Mount Sinai. University of Michigan Health. University of Kansas Hospital Authority."
...
Three nonprofit hospital systems sued CVS Health on May 21.
...
## Post 76 - Friday 8:30 AM
### "The Savings Sitting on Your Formulary" Tease Hook (Text) - TEASES WEEK 22: BIOSIMILAR STRATEGY
...
This is not a clinical decision. The clinical evidence is clear. This is an economic decision. And the economics may be working in your PBM's favor, not yours.
...
>
> **Memorial Day Week Note:** Monday is a holiday. Consider skipping morning posting or shifting the Monday teaser to Tuesday morning. Engagement will be lower all week. Prioritize evergreen Notes that can circulate without time sensitivity.
...
> **Convention (see `x_account_strategy.md`):** 3 scheduled posts/day, plus same-hour reactions fired on top when PBM news breaks. **NOT locked to Monday's quarterly-reporting topic** — X skews to breaking news and the Cuban-bait shapes (dollar comparison, named-adversary, decoder). This is the **X launch week**, riding the live vertical-integration trifecta (CVS 340B suit / PA Act 77 study / CVS-sues-Tennessee). Schedule via X native scheduler or Typefully. `[VISUAL]` flags posts that attach an asset; links go in the FIRST REPLY, never the post body. Slot times ET. Account is live at `@ginny_crisp` (bio, header, pinned post set May 24, 2026).
>
...
**Mon May 25**
- **AM — named-adversary / GLP-1 (text-only):** The fastest-growing line on your pharmacy spend is a GLP-1. Here's what your PBM won't volunteer: which one your plan covers usually has less to do with which works best and more to do with which manufacturer wrote the bigger rebate check. The drug on your formulary is the one that paid to be there. _(Replaces the 340B/CVS news reaction, which shipped a day early on Sun May 24 — see the Sunday launch-day log below. Deliberately steers off vertical integration to break the 3-day VI run; GLP-1 is the documented topic-level amplifier and had no standalone X post this week.)_
...
- **PM — Library 02 driver / termination-clause decoder (text-only, schedule AFTER the 8:30 AM LinkedIn publish):** Every PBM contract says you can terminate. The clause that actually matters is what happens the day after: who owns your claims data, and how your runout claims get priced once you've given notice. That's where "you're free to leave" quietly becomes "good luck leaving clean." The best brokers read the exit terms before signing the entry.
  - **First reply (link):** The full five clauses the best brokers check before a renewal are in the Contract Language Library: benefitblindspots.substack.com/p/pbm-contract-language-library
  - _(Replaced the single-carousel-slide driver: a redline Library slide is bookmark-built for LinkedIn, not X-native, and one slide out of context reads as a busy legal screenshot. Switched to a text decode of one clause + Library link. Picked the termination/runout clause over audit-rights to avoid duplicating Friday midday's audit-rights post, and because it ties to the week's "can you actually leave" through-line.)_
...
**Debut timeline post (separate from the reactions below):** the account's first scheduled timeline post also went out Sunday ~9:30 AM ET — the 340B/CVS news reaction originally scheduled for Mon AM ("Three hospital systems sued CVS Health… $250M in 340B savings diverted through vertical integration," Fierce Healthcare headline + source in first reply). It shipped a day early as the launch kickoff (21 views by early afternoon), so the Monday AM slot was reslotted to a GLP-1 post (see the Mon May 25 schedule above). Calendar drift logged so the schedule stays honest.
...
- [ ] **Wed Substack Roundup (Wed 7:30 AM) story-order verification: trifecta required in order.** Tuesday May 26 morning, after auto-generation runs, open `newsletters/roundups/roundup_2026_05_26.md` and confirm all three. **Lead:** CVS / Mount Sinai / U Michigan / U Kansas 340B suits (filed May 21, ~$250M alleged diversion). **#2:** Pennsylvania Insurance Department study released May 21 under Act 77 — Freedman Healthcare analysis of Caremark / Express Scripts / Navitus / OptumRx / Prime Therapeutics on 2022-2024 fully-insured data; findings: steering limited, spread pricing decreasing under state pressure, NADAC + $10.49 would redistribute $14M (0.3%) to independent retail pharmacies. **#3:** CVS sues Tennessee to block PBM divestiture law (filed May 22 in U.S. District Court for Middle District of Tennessee); CVS argues Dormant Commerce Clause violation + federal preemption; cites the Arkansas parallel law blocked by federal judge July 2025. Bill sponsor state Sen. Bobby Harshbarger, R-Kingsport. **48-hour-arc framing:** May 21 hospital suits show where extraction happens (vertical integration); PA study shows where state pressure has reshaped traditional spread pricing; CVS TN countersuit shows PBMs litigating to protect the vertical-integration model the other two stories expose. PBS's interpretive read: PBMs are evolving extraction methods faster than regulators can document them, and where regulators do catch up, PBMs are litigating to block the law. If automation surfaced different leads, manually re-anchor before publish. W20 history (`roundup_2026_05_19.md` header line 2) shows automation has overwritten pre-curated leads before.
