  ...
  if (coverMode) {
    ...
    return (
      <AbsoluteFill style={{ backgroundColor: "#000", fontFamily: SANS, overflow: "hidden" }}>
        ...
        <Img src={staticFile("pbs-logo-white.png")} style={{ position: "absolute", top: 28, left: SAFE_CORNER, height: 48, width: "auto", filter: "drop-shadow(0 2px 6px rgba(0,0,0,0.75))" }} />
