...
| GWCU | Mike Thomson | Toolkit funnel (bulk download, Jun 2026) | COLLABORATING | **Jul 13, 2026: follow-up sent (Brett)** — re-engaged the Jun 23 materials thread, attached the broker one-pager (enablement kit ✅ SENT), named the ~Oct 1 notice-window timing, asked for agreement questions or a first-client fit + 20-min call | Await reply. If quiet by ~Jul 24: ONE light LinkedIn touch (no second email), then sales-hour queue | The proof pattern. Jun 23 email had brochure + Consulting Services Agreement + project-request link; Ginny then PTO through Jun 30. |
...
| Health Compass Consulting (Orlando, FL) | Bunky Garrabrant (Director of Procurement & Implementation) — direct 407-453-0331 | Toolkit funnel PARTNER alert Jul 13, 2026 + **paid monthly Substack sub Jul 11** (the Rising-badge trigger) | CONTACTED → **MEETING Mon Jul 20, 2026 (today)** | Jul 13: P1 sent, Bunky replied same morning; meeting emailed/set for Jul 20 | **Call brief ready: `leads/health_compass_call_brief.md`** (vetting criteria, Ginny's asks, pilot-vs-matrix next steps, landmines). Log outcome here same day; target status COLLABORATING | **His reply (Jul 13): CEO Pyle "discovered your work last week" and directed him to study ALL PBS resources ("a veritable crash course in vetting and procuring PBMs"). No live mid-year client; they are building a "comprehensive matrix of vendors aligned with our fiduciary approach" for their procurement process — PBS is being vetted for their PARTNER PANEL, i.e., a standing referral channel, not a one-off.** Founded 2018 by Pyle (Validation Institute senior advisor); fee-based, anti-commission = ideological twin of PBS independence. |
| Ethos Benefits (Donovan Ryckis's firm; fee-based fiduciary, FL HQ / national) | Jacob L. (Account Manager & Actuary, Pittsburgh remote; joined Jun 2026; ex-UPMC/Acrisure/Cowden) | **Followed Ginny since May 2026**; found Substack via GOOGLE (organic/AEO win); free sub + channel-pricing toolkit Jul 13, 2026 | LEAD | — | Ginny LinkedIn connect + warm no-pitch note (he's the internal champion, not the decision-maker; Ryckis is the principal). 6 mutual connections incl. a "Mike" — check if Mike Thomson (GWCU) for a warm path. | 2nd fiduciary-movement firm in 3 days (after Health Compass) = the community is circulating PBS content. Sequence the principal-level approach after/alongside the Health Compass conversation; don't run three cold notes into one community. |
| Target Group LLC (PBM-focused benefits consulting) | Roy L Armstrong, Principal (also appears as Strategic BD Advisor at Ventegra, a PBM-alternative pharmacy services org; SIIA conference circuit) | Toolkit funnel PARTNER alert; **3rd toolkit download Jul 2026** (latest: Channel Pricing) = Email 08 trigger | LEAD — **QUALIFY FIRST → MEETING SET (August)** | Jul 2026: emailed; meeting set for August (sheet note Jul 20) | Before the August call: run the qualify screen AS the meeting agenda (what he is working on, how the worksheets get used, where Ventegra fits). Still NO enablement kit or pricing detail until sorted partner-vs-peer. Build a call brief the week before. | ⚠ A PHARMACY-specialist consultancy with a PBM-alternative vendor affiliation is closer to a peer/competitor than the fiduciary-generalist archetype; do NOT send the enablement kit or pricing detail until qualified. Small principal shops do refer overflow work, so a conversation is still worth one touch. |
| Benecon (PA-based benefits consortium / self-funded captive programs) | Nick Miller (benecon.com email on the toolkit lead — authoritative; a "K. Nick Miller, PharmD, Certified Pharmacy Benefits Specialist" shows as Senior Director, Strategic Partnerships at Rightway on LinkedIn, so either a namesake or he has moved — CONFIRM IDENTITY before outreach) | Toolkit funnel, Jul 2026 | LEAD | — | Confirm who he is (Benecon staff page / LinkedIn search on "Miller Benecon") before any touch. If Benecon-side: strong PARTNER candidate (consortium = many self-funded plans, one relationship). If Rightway-side: peer/competitor watch class, no kit. | A consortium/captive administrator is the highest-leverage partner archetype on the list if confirmed: one COLLABORATING relationship = a book of self-funded groups. |
| *(open)* | | | | | | Target: fill from PARTNER-tier alerts + Broker-pillar content respondents. |

**Non-partner lead triage (Jul 20, 2026 sheet review — logged so the sheet's names don't get re-researched):**
- **Christian Nygaard — Director, Pharmacy Consulting at Huron** (confirmed via search): provider-side consulting (340B / specialty / health-system pharmacy). Watch class, not a partner or buyer lane; no outreach. Like Jake Goll (Prism Health Group, Jul 17), a competitor/peer deep-reading PBS material = moat validation, not pipeline.
- **Patrick Robinson (BCBSMA)** and **Erik (OneAnother Health)**: NURTURE — carrier-side and vendor-side respectively; they stay on the standard email sequence, no personal outreach.
- **GWCU / Mike Thomson** continues bulk-downloading (~23 toolkits now) — already COLLABORATING above; the downloads are usage, not a new signal.
