...
- [x] ✅ Jul 23 — spread-pricing re-adds DONE (companion sentence in "How do you start" + Keep-reading row, live same day that guide published). choose-an-auditor Keep-reading row added Jul 23 — §7 FULLY CLOSED.
